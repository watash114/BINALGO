...
$monthlyRevenue = (float) $db->query("SELECT COALESCE(SUM(total_amount), 0) FROM payments WHERE payment_status = 'paid' AND created_at >= date('now', 'start of month')")->fetchColumn();
