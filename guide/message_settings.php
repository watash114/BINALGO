...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && verify_token($_POST['csrf_token'] ?? null)) {
    if (isset($_POST['save_settings'])) {
        ...
        redirect('/guide/message_settings.php');
    }
...
render_page('guide', 'message_settings.php', 'Message Settings', function () use ($settings, $blockedUsers, $searchResults, $searchBlock, $role, $user_id) {
?>
...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?= BASE_URL ?>/guide/messages.php" class="btn btn-outline-secondary btn-sm"><i class="fas fa-arrow-left me-1"></i>Back to Messages</a>
</div>
    ...
    <div class="settings-section">
        ...
        <div class="setting-row">
            ...
            <select class="form-select form-select-sm w-auto" name="who_can_message">
                ...
                <option value="booked_only" <?= $settings['who_can_message'] === 'booked_only' ? 'selected' : '' ?>>Booked Tourists Only</option>
            </select>
        </div>
    </div>
